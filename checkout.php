...
<section class="checkout-orders">
   ...
   <form action="CheckoutWithAnim.php" method="POST" onsubmit="myFunc();">
   ...
   <button input type="submit" name="order" class="truck-button <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="startButtonAnimation()">
