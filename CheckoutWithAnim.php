...
<head>
   ...
   <link rel="stylesheet" href="css/truckanim.css">
...
<section class="checkout-orders">
   ...
   <form action="" method="POST" onsubmit="myFunc();">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="options" class="box"  required>
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" placeholder="e.g. Bacoor" class="box"  maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>state :</span>
   ...
   <button input type="submit" name="order" class="truck-button">
      <span class="default">Complete Order</span>
      <span class="success">Order Placed Successfully<svg viewbox="0 0 12 10"><polyline points="1.5 6 4.5 9 10.5 1"></polyline></svg></span>
...
<script src="js/AutoTruck.js"></script>
</body>
